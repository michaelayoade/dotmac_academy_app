...
ACTION = "michaelayoade/dotmac_starter_mt/" ".github/actions/verify-composition-observations"
PRODUCT = "academy"
...
def _require_exact_action_binding(workflow: dict[str, object], record: dict[str, object]) -> None:
